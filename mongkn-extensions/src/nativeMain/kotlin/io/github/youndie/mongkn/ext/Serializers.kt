...
public object StringAsBsonObjectId : KSerializer<String> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.youndie.mongkn.ext.StringAsBsonObjectId", PrimitiveKind.STRING)
...
public object InstantAsBsonDateTime : KSerializer<Instant> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.youndie.mongkn.ext.InstantAsBsonDateTime", PrimitiveKind.LONG)
