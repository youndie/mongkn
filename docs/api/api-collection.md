...
> **Статус: реализовано.** Шесть операций, 28 тестов против настоящего mongod — из них 3
> дифференциальных, сверяющих нас с официальным драйвером. Поверхность рукописная;
