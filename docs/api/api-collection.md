...
> **Статус: реализовано.** Шесть операций, 35 тестов против настоящего mongod — из них 3
> дифференциальных, сверяющих нас с официальным драйвером, и 7 стрессовых. Поверхность рукописная;
