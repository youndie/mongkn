...
> **Статус: реализовано.** Шесть операций, 33 теста против настоящего mongod — из них 3
> дифференциальных, сверяющих нас с официальным драйвером, и 5 стрессовых. Поверхность рукописная;
