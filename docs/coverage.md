...
| Сессии и транзакции | `startSession`, `withTransaction` с повторами по меткам сервера; изоляция проверена, а не только успех коммита |
| Проверки | 233 теста на двух платформах, ABI-валидация, ktlint в гейте |
