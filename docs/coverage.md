...
| Соответствие спецификации | **67** официальных сценариев MongoDB из 69, включая проверку отправленных команд, инсценированных сбоев и кодов ошибок. Оставшиеся 2 требуют версии сервера, которой у нас нет, — раннером это не закрывается (M-80) |
