...
| Соответствие спецификации | **63** официальных сценария MongoDB, включая проверку отправленных команд; непокрытыми остались 6 по разным мелким причинам. Раннер различает топологии, то есть требование `runOnRequirements` проверяется целиком, а не наполовину |
...
| Проверки | 243 теста на двух платформах, ABI-валидация, ktlint в гейте |
