...
| Проверки | 294 теста на macOS, 277 из них выполняются и на Linux; ABI-валидация на публикуемой платформе (linuxX64), ktlint в гейте; инсценированные сбои адресованы своему клиенту по `appName` (M-82) |
