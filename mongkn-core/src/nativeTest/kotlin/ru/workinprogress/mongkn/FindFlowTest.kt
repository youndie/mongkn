...
class FindFlowTest {
    ...
    @Test
    fun `limit and skip narrow the result`() =
        runTest {
    ...
    @Test
    fun `projection drops the fields it was not asked for`() =
        runTest {
    ...
    @Test
    fun `repeating an option replaces it instead of sending two`() =
        runTest {
    ...
    @Test
    fun `the chain is reusable because every step returns a new flow`() =
        runTest {
    ...
    @Test
    fun `upsert creates a document when nothing matched`() =
        runTest {
