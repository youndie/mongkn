...
class SpecConformanceTest {
    ...
    private companion object {
         ...
         *
         * 67 из 69: оставшиеся два сценария требуют версии сервера, которой у нас нет, и снять
         * их поддержкой раннера нельзя в принципе (M-80).
         */
        const val MINIMUM_EXECUTED = 67
    }
}
