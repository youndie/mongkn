 ...
 * с полями вместо строк, здесь **не используется**: заголовка `mongoc-structured-log.h` нет
 * в libmongoc **1.26** — версии из Ubuntu 24.04 LTS, на которую мы держим нижнюю границу.
 *
 * Это ограничение конкретной версии, а не ветки 1.x: в 1.30 (Debian 13, Ubuntu 25.04)
 * структурированное логирование уже есть. Поднимется нижняя граница — появится и здесь (M-81).
 */
